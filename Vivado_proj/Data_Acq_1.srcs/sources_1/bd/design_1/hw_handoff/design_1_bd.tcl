...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ADC1_in_A [ create_bd_port -dir I -from 7 -to 0 -type data ADC1_in_A ]
  set ADC1_in_B [ create_bd_port -dir I -from 7 -to 0 -type data ADC1_in_B ]
  set ADC2_in_A [ create_bd_port -dir I -from 7 -to 0 -type data ADC2_in_A ]
  set ADC2_in_B [ create_bd_port -dir I -from 7 -to 0 -type data ADC2_in_B ]
  set LED_B [ create_bd_port -dir O -from 0 -to 0 -type data LED_B ]
  set LED_G [ create_bd_port -dir O -from 0 -to 0 -type data LED_G ]
  set LED_R [ create_bd_port -dir O -from 0 -to 0 -type data LED_R ]
  set MARGIN [ create_bd_port -dir O -from 0 -to 0 MARGIN ]
  set MAX_BW [ create_bd_port -dir O -from 0 -to 0 MAX_BW ]
  set SSCG [ create_bd_port -dir O -from 0 -to 0 SSCG ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.Threshold_Value {3FFFFE} \
 ] $c_counter_binary_0

  # Create instance: clk_wiz_0, and set properties
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_0 ]
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {138.88} \
   CONFIG.CLKOUT1_JITTER {151.031} \
   CONFIG.CLKOUT1_PHASE_ERROR {102.228} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {72} \
   CONFIG.CLKOUT2_JITTER {235.726} \
   CONFIG.CLKOUT2_PHASE_ERROR {102.228} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {9} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_JITTER {145.402} \
   CONFIG.CLKOUT3_PHASE_ERROR {118.291} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {160} \
   CONFIG.CLKOUT3_REQUESTED_PHASE {180} \
   CONFIG.CLKOUT3_USED {false} \
   CONFIG.CLK_OUT1_PORT {clk_72M} \
   CONFIG.CLK_OUT2_PORT {clk_9M} \
   CONFIG.CLK_OUT3_PORT {clk_160M} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {13.875} \
   CONFIG.MMCM_CLKIN1_PERIOD {13.889} \
   CONFIG.MMCM_CLKIN2_PERIOD {10.0} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {13.875} \
   CONFIG.MMCM_CLKOUT1_DIVIDE {111} \
   CONFIG.MMCM_CLKOUT2_DIVIDE {1} \
   CONFIG.MMCM_CLKOUT2_PHASE {180.000} \
   CONFIG.MMCM_DIVCLK_DIVIDE {1} \
   CONFIG.NUM_OUT_CLKS {2} \
   CONFIG.PRIM_IN_FREQ {72} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.Empty_Threshold_Assert_Value_axis {2045} \
   ...
   CONFIG.Full_Threshold_Assert_Value_axis {1500} \
  ...
  connect_bd_net -net ADC1_in_A_1 [get_bd_ports ADC1_in_A] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net ADC1_in_B_1 [get_bd_ports ADC1_in_B] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net ADC2_in_A_1 [get_bd_ports ADC2_in_A] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net ADC2_in_B_1 [get_bd_ports ADC2_in_B] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net ADC_handler_0_data_out_IQ [get_bd_pins fifo_generator_0/din] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net axi_dma_s_axis_s2mm_tready [get_bd_pins axi_dma/s_axis_s2mm_tready] [get_bd_pins fifo_generator_0/rd_en]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins fifo_generator_0/wr_en]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net clk_wiz_0_clk_72M [get_bd_pins clk_wiz_0/clk_72M] [get_bd_pins fifo_generator_0/wr_clk]
  connect_bd_net -net clk_wiz_0_clk_9M [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clk_wiz_0/clk_9M]
  connect_bd_net -net fifo_generator_0_dout [get_bd_pins axi_dma/s_axis_s2mm_tdata] [get_bd_pins fifo_generator_0/dout]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins fifo_generator_0/rd_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_dma/s_axis_s2mm_tlast] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axi_dma/s_axis_s2mm_tvalid] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_ports MARGIN] [get_bd_ports MAX_BW] [get_bd_ports SSCG] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_ports LED_B] [get_bd_ports LED_G] [get_bd_pins xlconstant_4/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports LED_R] [get_bd_pins xlslice_0/Dout]
